...
func TestGet(t *testing.T) {
	...
	t.Run("unexpected_error", func(t *testing.T) {
		...
		warehouseRepositoryMock := new(mocks.WarehouseRepositoryMock)
		warehouseRepositoryMock.On("Get", ctx, mock.AnythingOfType("int")).Return(domain.Warehouse{}, errors.New("error"))
...
func TestDelete(t *testing.T) {
	t.Run("delete_ok", func(t *testing.T) {
		...
		warehouseRepositoryMock := new(mocks.WarehouseRepositoryMock)
		warehouseRepositoryMock.On("Delete", ctx, mock.AnythingOfType("int")).Return(nil)
	...
	t.Run("delete_non_existent", func(t *testing.T) {
		...
		warehouseRepositoryMock := new(mocks.WarehouseRepositoryMock)
		warehouseRepositoryMock.On("Delete", ctx, mock.AnythingOfType("int")).Return(sql.ErrNoRows)
	...
	t.Run("delete_unexpected_error", func(t *testing.T) {
		...
		warehouseRepositoryMock := new(mocks.WarehouseRepositoryMock)
		warehouseRepositoryMock.On("Delete", ctx, mock.AnythingOfType("int")).Return(errors.New("error"))
...
func TestCreate(t *testing.T) {
	...
	t.Run("create_error", func(t *testing.T) {
		...
		warehousetRepositoryMock.On("Save", ctx, mock.AnythingOfType("dtos.WarehouseRequestDTO")).Return(0, errors.New("error"))
	...
	t.Run("create_error_get_warehouse", func(t *testing.T) {
		...
		warehouseRepositoryMock.On("Save", ctx, mock.AnythingOfType("dtos.WarehouseRequestDTO")).Return(1, nil)
		warehouseRepositoryMock.On("Get", ctx, mock.AnythingOfType("int")).Return(domain.Warehouse{}, errors.New("error"))
...
func TestUpdate(t *testing.T) {
	t.Run("update_existent", func(t *testing.T) {
		...
		warehouseRepositoryMock.On("Exists", ctx, mock.AnythingOfType("string")).Return(false)
		warehouseRepositoryMock.On("Update", ctx, mock.AnythingOfType("int"), mock.AnythingOfType("dtos.WarehouseRequestDTO")).Return(nil)

		service := warehouse.NewService(warehouseRepositoryMock)
		warehouseUpdated, err := service.Update(&ctx, 1, updateWarehouseRequestDTO)

		assert.Equal(t, warehouseUpdated, originalWarehouse)
		assert.Nil(t, err)
	})
