...
func Test_productHandler_Get(t *testing.T) {
	...
	t.Run("get_find_by_id_non_existent", func(t *testing.T) {
		...
		productServiceMock.On("Get", mock.AnythingOfType("*context.Context"), mock.AnythingOfType("int")).Return(&entities.Product{}, services.ErrNotFound)
		handler := handlers.NewProductHandler(productServiceMock)
	...
	t.Run("get_internal_server_error", func(t *testing.T) {
		...
		productServiceMock.On("Get", mock.AnythingOfType("*context.Context"),
			mock.AnythingOfType("int")).Return(&entities.Product{}, assert.AnError)
		handler := handlers.NewProductHandler(productServiceMock)
...
func Test_productHandler_Create(t *testing.T) {
	...
	t.Run("create_fail_description_empty", func(t *testing.T) {
		...
		productServiceMock.On("Save", mock.AnythingOfType("*context.Context"), mock.AnythingOfType("string"), mock.AnythingOfType("int"),
			...
			mock.AnythingOfType("int")).Return(&entities.Product{}, services.ErrConflict)
		handler := handlers.NewProductHandler(productServiceMock)
	...
	t.Run("create_internal_server_error", func(t *testing.T) {
		...
		productServiceMock.On("Save", mock.AnythingOfType("*context.Context"), mock.AnythingOfType("string"), mock.AnythingOfType("int"),
			mock.AnythingOfType("int"), mock.AnythingOfType("float32"), mock.AnythingOfType("float32"), mock.AnythingOfType("float32"),
			mock.AnythingOfType("string"), mock.AnythingOfType("float32"), mock.AnythingOfType("float32"), mock.AnythingOfType("int"),
			mock.AnythingOfType("int")).Return(&entities.Product{}, errors.New("error"))
		handler := handlers.NewProductHandler(productServiceMock)
...
func Test_productHandler_GetAll(t *testing.T) {
	...
	t.Run("getAll_find_all", func(t *testing.T) {
		productsFounds := &[]entities.Product{
			{
				ID:             1,
				Description:    "Test",
				ExpirationRate: 1,
...
func Test_productHandler_Delete(t *testing.T) {

	t.Run("delete_non_existent", func(t *testing.T) {

		//Configurar o mock do service
		productServiceMock := new(mocks.ProductServiceMock)
		productServiceMock.On("Delete", mock.AnythingOfType("*context.Context"), mock.AnythingOfType("int")).Return(services.ErrNotFound)
		handler := handlers.NewProductHandler(productServiceMock)
...
func Test_productHandler_Update(t *testing.T) {
	...
	t.Run("update_non_existent", func(t *testing.T) {
		...
		updateProductRequest := handlers.RequestUpdateProduct{
		...
		productServiceMock.On(
			...
			&entities.Product{}, services.ErrNotFound,
		)
		handler := handlers.NewProductHandler(productServiceMock)
	...
	t.Run("update_conflict", func(t *testing.T) {
		...
		productServiceMock.On(
			...
			&entities.Product{}, services.ErrConflict,
		)
		handler := handlers.NewProductHandler(productServiceMock)
	...
	t.Run("update_internal_server_error", func(t *testing.T) {
		...
		productServiceMock.On(
			...
			&entities.Product{}, errors.New("error"),
		)
		handler := handlers.NewProductHandler(productServiceMock)
...
func buildProductRequestDTO(description string, expirationRate int, freezinRate int, height float32, length float32, netweight float32, productCode string,
	recomFreezTemp float32, width float32, productTypeID int, sellerId int) handlers.RequestCreateProduct {
	return handlers.RequestCreateProduct{
		Description:    description,
		ExpirationRate: expirationRate,
