...
(
    ...
    REFERENCES `melisprint`.`countries`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `melisprint`.`provinces`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    INDEX `locality_id_idx`
(
    `locality_id` ASC
) VISIBLE,
    UNIQUE INDEX `cid_UNIQUE`
(
    `cid` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `melisprint`.`localities`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    `recommended_freezing_temperature` DECIMAL
(
    19,
    2
) NOT NULL,
    `freezing_rate` DECIMAL
(
    19,
    2
) NOT NULL,
...
(
    ...
    INDEX `product_type_id_idx`
(
    `product_type_id` ASC
) VISIBLE,
    UNIQUE INDEX `product_code_UNIQUE`
(
    `product_code` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `melisprint`.`product_types`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    UNIQUE INDEX `warehouse_code_UNIQUE`
(
    `warehouse_code` ASC
) VISIBLE,
...
(
    ...
    INDEX `warehouse_id_idx`
(
    `warehouse_id` ASC
) VISIBLE,
    UNIQUE INDEX `section_number_UNIQUE`
(
    `section_number` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `melisprint`.`warehouses`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `melisprint`.`products`
(
    `id`
)
    ON DELETE CASCADE
...
(
    ...
    REFERENCES `melisprint`.`sections`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    UNIQUE INDEX `card_number_id_UNIQUE`
(
    `card_number_id` ASC
) VISIBLE)
    ENGINE = InnoDB;
...
(
    ...
    INDEX `carrier_id_idx`
(
    `carrier_id` ASC
) VISIBLE,
    INDEX `order_status_id_idx`
(
    `order_status_id` ASC
) VISIBLE,
    INDEX `warehouse_id_idx`
(
    ...
    INDEX `fk_product_record_orders_idx`
(
    `product_record_id` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `melisprint`.`carriers`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `melisprint`.`order_status`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `melisprint`.`product_records`
(
    `id`
)
    ON DELETE CASCADE
...
(
    ...
    INDEX `product_record_id_idx`
(
    `product_record_id` ASC
) VISIBLE,
    INDEX `purchase_order_id_idx`
(
...
(
    ...
    REFERENCES `melisprint`.`purchase_orders`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `melisprint`.`employees`
(
    `id`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `melisprint`.`product_batches`
(
    `id`
)
    ON DELETE CASCADE
