...
//	@Failure		400	{object}	web_utils.errorResponse
//	@Failure		404	{object}	web_utils.errorResponse
//	@Failure		500	{object}	web_utils.errorResponse
...
func (handler *LocalityHandler) Get() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if locality, err := handler.localityService.Get(&ctx, id); err != nil {
			...
			web_utils.Response(c, http.StatusOK, locality)
			return
		}
...
//	@Accept			json
//	@Produce		json
//	@Success		200	{object}	web_utils.response{data=[]entities.Locality}
//	@Failure		500	{object}	web_utils.errorResponse
...
func (handler *LocalityHandler) GetAll() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if localities, err := handler.localityService.GetAll(&ctx); err != nil {
			...
			if len(localities) == 0 {
				web_utils.Success(c, http.StatusNoContent, localities)
				return
			}
			web_utils.Success(c, http.StatusOK, localities)
			return
		}
	}
}
...
//	@Accept			json
//	@Produce		json
//	@Param			SellerHandler	body		entities.Locality	true	"Locality to Create"
//	@Success		201		{object}	entities.Locality
//	@Failure		422		{object}	web_utils.errorResponse
//	@Failure		500		{object}	web_utils.errorResponse
...
func (handler *LocalityHandler) Create() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if createdLocality, err := handler.localityService.Create(&ctx, createLocalityRequest); err != nil {
			...
			web_utils.Response(c, http.StatusCreated, createdLocality)
			return
		}
	}
}
...
func (handler *LocalityHandler) Update() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if updatedLocality, err := handler.localityService.Update(&ctx, id, updateLocalityRequest); err != nil {
			...
			web_utils.Response(c, http.StatusOK, updatedLocality)
			return
		}
	}
}
...
func (handler *LocalityHandler) Delete() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := handler.localityService.Delete(&ctx, id); err != nil {
			...
			web_utils.Response(c, http.StatusNoContent, nil)
			return
		}
	}
}
...
//	@Produce		json
//	@Param			id		path		string						true	"ID of Locality to be searched"
//	@Success		200		{object}	web_utils.response{data=dtos.GetNumberOfSellersResponseDTO}
//	@Failure		400		{object}	web_utils.errorResponse
//	@Failure		404		{object}	web_utils.errorResponse
//	@Failure		422		{object}	web_utils.errorResponse
//	@Failure		500		{object}	web_utils.errorResponse
...
func (handler *LocalityHandler) CountSellers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		web_utils.Success(c, http.StatusOK, response)
		return
