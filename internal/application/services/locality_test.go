...
func Test_localityService_GetAll(t *testing.T) {
	...
	expectedLocalitiesSerialized, _ := os.ReadFile("../../../tests/resources/valid_localities.json")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			sellerRepositoryMock := mocks.NewLocalityRepositoryMock(t)
...
func Test_localityService_Get(t *testing.T) {
	...
	expectedLocalitySerialized, _ := os.ReadFile("../../../tests/resources/valid_locality.json")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			localityRepositoryMock := mocks.NewLocalityRepositoryMock(t)
...
func Test_localityService_Update(t *testing.T) {
	...
	originalLocalitySerialized, _ := os.ReadFile("../../../tests/resources/valid_locality.json")
