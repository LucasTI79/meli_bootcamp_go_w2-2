...
type ProductService interface {
	Save(ctx *context.Context, description string, expiration_rate, freezing_rate int, height, length, netweight float32, product_code string,
		recommended_freezing_temperature, width float32, product_type_id, seller_id int) (*entities.Product, error)
	...
	Update(ctx *context.Context, description *string, expiration_rate, freezing_rate *int, height, length, netweight *float32, product_code *string,
		recommended_freezing_temperature, width *float32, product_type_id, seller_id *int, id int) (*entities.Product, error)
}
...
func (s *productService) Save(ctx *context.Context, description string, expiration_rate, freezing_rate int, height, length, netweight float32, product_code string,
	recommended_freezing_temperature, width float32, product_type_id, seller_id int) (*entities.Product, error) {
...
func (s *productService) Get(ctx *context.Context, id int) (*entities.Product, error) {
...
func (s *productService) Update(ctx *context.Context, description *string, expiration_rate, freezing_rate *int, height, length, netweight *float32, product_code *string,
	recommended_freezing_temperature, width *float32, product_type_id, seller_id *int, id int) (*entities.Product, error) {
