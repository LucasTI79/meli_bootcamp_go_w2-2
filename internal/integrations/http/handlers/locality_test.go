...
func Test_localityHandler_Get(t *testing.T) {

	localitySerialized, _ := os.ReadFile("../../../../tests/resources/valid_locality.json")
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			localityServiceMock := mocks.NewLocalityServiceMock(t)
...
func Test_localityHandler_GetAll(t *testing.T) {

	localitiesSerialized, _ := os.ReadFile("../../../../tests/resources/valid_localities.json")
...
func Test_localityHandler_Delete(t *testing.T) {
...
func Test_localityHandler_Create(t *testing.T) {
...
func Test_localityHandler_Update(t *testing.T) {
...
func Test_localityHandler_GetNumberOfSellers(t *testing.T) {
	localitySerialized, _ := os.ReadFile("../../../../tests/resources/valid_locality.json")
	var validLocality entities.Locality
	if err := json.Unmarshal(localitySerialized, &validLocality); err != nil {
		t.Fatal(err)
