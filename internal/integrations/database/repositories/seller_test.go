...
func Test_repository_GetAll(t *testing.T) {
	...
	var validSellers []entities.Seller
...
func Test_repository_Get(t *testing.T) {
	...
	var validSeller entities.Seller
...
func Test_repository_Exists(t *testing.T) {
	...
	validSellerSerialized, _ := os.ReadFile("../../../../tests/resources/valid_seller.json")
	var validSeller entities.Seller
