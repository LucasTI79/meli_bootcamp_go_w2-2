...
func Test_buyerHandler_Get(t *testing.T) {

	buyerSerialized, _ := os.ReadFile("../../../../tests/resources/valid_buyer.json")
	var validBuyer entities.Buyer
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			buyerServiceMock := mocks.NewBuyerServiceMock(t)
			...
			if test.expectedCode == http.StatusOK {
				//Parsear response
				var buyerResponse entities.Buyer
...
func Test_buyerHandler_GetAll(t *testing.T) {
	...
	tests := []struct {
		...
		expectedResponse     *[]entities.Buyer
		expectedCode         int
	}{
		{
...
func Test_buyerHandler_Delete(t *testing.T) {
...
func Test_buyerHandler_Create(t *testing.T) {
	...
	tests := []struct {
		name                 string
		createBuyerRequest   dtos.CreateBuyerRequestDTO
		expectedCreateResult *entities.Buyer
...
func Test_buyerHandler_Update(t *testing.T) {
	...
	tests := []struct {
		...
		id                   string
		updateBuyerRequest   dtos.UpdateBuyerRequestDTO
		expectedUpdateResult *entities.Buyer
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			buyerServiceMock := mocks.NewBuyerServiceMock(t)
			buyerServiceMock.On("Update", mock.AnythingOfType("*context.Context"), mock.AnythingOfType("int"), mock.AnythingOfType("*dtos.UpdateBuyerRequestDTO")).Return(test.expectedUpdateResult, test.expectedUpdateError)
