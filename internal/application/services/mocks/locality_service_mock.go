...
// LocalityServiceMock is an autogenerated mock type for the LocalityService type
type LocalityServiceMock struct {
	mock.Mock
}

// CountSellers provides a mock function with given fields: ctx, id
func (_m *LocalityServiceMock) CountSellers(ctx *context.Context, id int) (int, error) {
...
func (_m *LocalityServiceMock) Create(ctx *context.Context, locality entities.Locality) (entities.Locality, error) {
...
func (_m *LocalityServiceMock) Delete(ctx *context.Context, id int) error {
	ret := _m.Called(ctx, id)
...
func (_m *LocalityServiceMock) Get(ctx *context.Context, id int) (entities.Locality, error) {
	ret := _m.Called(ctx, id)
...
func (_m *LocalityServiceMock) GetAll(ctx *context.Context) ([]entities.Locality, error) {
	ret := _m.Called(ctx)
...
func (_m *LocalityServiceMock) Update(ctx *context.Context, id int, updateLocalityRequest dtos.UpdateLocalityRequestDTO) (entities.Locality, error) {
...
// NewLocalityServiceMock creates a new instance of LocalityServiceMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewLocalityServiceMock(t interface {
	mock.TestingT
	Cleanup(func())
}) *LocalityServiceMock {
